    ...
    <div style={{ background: "#070b12", color: "#fff", fontFamily: "'DM Sans','Helvetica Neue',sans-serif", overflowX: "hidden", "--mx": mouse.x, "--my": mouse.y }}>
      ...
      <section id="pricing" style={{ padding: "100px 48px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "2px", color: "#1a82ff", textTransform: "uppercase", marginBottom: 14 }}>Pricing</div>
            <h2 style={{ fontSize: "clamp(30px,5vw,52px)", fontWeight: 800, letterSpacing: "-2px", margin: "0 0 12px" }}>Simple, honest pricing.</h2>
            <p style={{ fontSize: 15, color: "rgba(255,255,255,0.38)", maxWidth: 380, margin: "0 auto" }}>Start free. Upgrade when you need more.</p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(190px,1fr))", gap: 14 }}>
            {[
              { name: "Free", price: "Free", period: "", credits: "4 credits / day", features: ["Single export only","Auto logo fetch","Gmail send"], highlight: false },
              { name: "SDR", price: "$19", period: "/mo", credits: "300 credits / month", features: ["Bulk send + export","Auto logo fetch","Gmail send"], highlight: false },
              { name: "Sales Pro", price: "$29", period: "/mo", credits: "2 000 credits / month", features: ["Everything in SDR","Priority support"], highlight: true },
              { name: "Team", price: "$59", period: "/mo", credits: "10 000 credits / month", features: ["Up to 5 seats","Everything in Pro"], highlight: false },
            ].map((p, i) => (
              <div key={i} style={{
