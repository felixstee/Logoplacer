...
function FeaturesShowcase() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: lang === "sv" ? "Dina Gmail-uppgifter och prospektdata lämnar aldrig din webbläsare. Ingen lagring på server överhuvudtaget." : "Your Gmail credentials and prospect data never leave your browser. No server-side storage of any kind.",
      accent: "#22d3ee",
      visual: (
        <div style={{ display: "flex", gap: 6, marginTop: 4, flexWrap: "wrap" }}>
          {(lang === "sv" ? ["Ingen server", "Krypterat", "GDPR"] : ["No server", "Encrypted", "GDPR"]).map((tag, i) => (
