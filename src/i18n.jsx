...
export const TRANSLATIONS = {
  ...
  "app.delete_account": { en: "Delete account", sv: "Radera konto" },
  "app.delete_account_confirm": { en: "Are you sure you want to permanently delete your account and all data? This cannot be undone.", sv: "Är du säker på att du vill radera ditt konto och all data permanent? Detta går inte att ångra." },
